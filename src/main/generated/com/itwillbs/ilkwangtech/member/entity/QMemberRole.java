...
public class QMemberRole extends EntityPathBase<MemberRole> {
    ...
    private static final long serialVersionUID = -400279257L;
    ...
    public final com.itwillbs.ilkwangtech.common.entity.QCommonCode role;
    ...
    public QMemberRole(Class<? extends MemberRole> type, PathMetadata metadata, PathInits inits) {
        ...
        this.role = inits.isInitialized("role") ? new com.itwillbs.ilkwangtech.common.entity.QCommonCode(forProperty("role")) : null;
    }
