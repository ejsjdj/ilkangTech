...
public class CommuteDTO {
    ...
    @Builder
    public CommuteDTO(long memberId, String depertment, LocalDateTime inTime, LocalDateTime goOutTime, LocalDateTime outTime, LocalDateTime returnTime){
        super();
