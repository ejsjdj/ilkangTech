...
-- ==============================================================================
-- 4. 신규 등록: 업체 정보 (Company) - 업체 코드 단축 및 데이터 보강
-- ==============================================================================
-- 고객사 (CompanyType: 2)
...
SELECT (SELECT MAX(sales_order_id) FROM sales_order), item_id, 100, 150000 FROM Item WHERE item_code = 'SAM-001';

INSERT INTO order_item (sales_order_id, item_id, quantity, unit_price) 
SELECT (SELECT MAX(sales_order_id) FROM sales_order), item_id, 50, 130000 FROM Item WHERE item_code = 'SAM-002';

-- ==============================================================================
-- 5. 대량 수주 및 납품 데이터 (테스트용)
-- ==============================================================================
