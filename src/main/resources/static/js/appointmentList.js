...
function renderTable(pageData) {
  ...
  let html = `
        ...
        <table class="table emp-table">
            <thead>
                <tr style="text-align: center;"> <th style="text-align: center;">발령대상자</th>
                    <th style="text-align: center;">이전 부서</th>
                    <th style="text-align: center;">현재 부서</th>
                    <th style="text-align: center;">이전 직급</th>
                    <th style="text-align: center;">현재 직급</th>
